...
public class BAddBudgetPanelOption_3 extends javax.swing.JPanel {
    ...
    private void jSaveBudgetButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSaveBudgetButtonActionPerformed
        ...
        if (!reportName.getText().isBlank() && !reportName.getText().equalsIgnoreCase("NOMBRE PRESUPUESTO")
                && !SelectedPlace.getText().isBlank() && comboBoxChooseVehicle.getSelectedIndex() != 0) {
